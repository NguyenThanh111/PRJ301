            ...
            <% UserDTO currentUser=(UserDTO) session.getAttribute("user"); String role=(String)
                ...
                <body>
                    ...
                    <div class="main-content">
                        ...
                        <div class="page-body">                                        <% if (isAdmin) { %>
                                                            ...
                                                            <table class="table-dark-custom">
                                                                ...
                                                                <tbody>
                                                                    <c:choose>
                                                                        <c:when test="${not empty authLogs}">
                                                                            <c:forEach var="log" items="${authLogs}">
                                                                                <tr>
                                                                                    ...
                                                                                    <td>${log.userName}</td>
                                                                                    <td>
                                                                                        <span class="${log.success ? 'badge-status-active' : 'badge-status-inactive'}">
                                                                                            ${log.loginStatus}
                                                                                        </span>
                                                                                    </td>
                                                                                    <td>${log.ipAddress}</td>
                                                                        ...
                                                                        <c:otherwise>
                                                                            <tr><td colspan="6" class="text-center" style="color: var(--text-muted); padding: 30px;">No authentication logs found.</td></tr>
                                                                        </c:otherwise>
                                                                    </c:choose>
                                                                </tbody>
                                                            </table>
                ...
                <form action="UserController" method="POST">
                    ...
                    <script>
                        ...
                        function showPage(pageId, triggerEl) {
                            // Auth Logs page has no inline sections to switch — just stay here.
                            // Other nav items navigate away via their <a href> links.
                        }
