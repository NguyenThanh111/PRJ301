                                                                        ...
                                                                        <c:when test="${not empty systemLogs}">
                                                                            <c:forEach var="log" items="${systemLogs}">
                                                                                <tr>
                                                                                    <td>${log.logId}</td>
                                                                                    <td>
                                                                                        <span class="badge-status-active" style="background: rgba(96, 165, 250, 0.16); color: #60a5fa; border-color: rgba(96, 165, 250, 0.4);">
                                                                                            ${log.action}
                                                                                        </span>
                                                                                    </td>
                                                                                    <td>${log.details}</td>
                                                                                    <td>${log.performedBy != null ? log.performedBy : 'SYSTEM'}</td>
                                                                                    <td><fmt:formatDate value="${log.createdAt}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                                                                </tr>
                                                                            </c:forEach>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <tr><td colspan="5" class="text-center" style="color: var(--text-muted); padding: 30px;">No system logs found.</td></tr>
                                                                        </c:otherwise>
                                                                    </c:choose>
                                                                </tbody>
                                                            </table>
                ...
                <form action="UserController" method="POST">
                    ...
                    <script>
                        ...
                        function showPage(pageId, triggerEl) {
                            // System Logs page has no inline sections to switch — just stay here.
