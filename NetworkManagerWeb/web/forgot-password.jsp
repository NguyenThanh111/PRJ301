...
<head>
    ...
    <title>Forgot Password — Network Manager</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .icon-wrap i { font-size: 28px; color: var(--neon-blue); }
        h2 {
        ...
        <form action="ForgotPasswordController" method="post">
            <div class="field">
                ...
                <div class="input-wrap">
                    ...
                    <input type="email" id="email" name="email" placeholder="you@university.edu" required autofocus>
                </div>
            </div>
